...
export default function Expertise() {
  ...
  return (
    <div className="bg-black text-black w-full min-h-screen flex flex-col items-center mb-[5vh] " id="expertise">
      <p className="text-3xl font-medium [@media(max-width:320px)]:text-3xl sm:text-3xl  md:text-7xl    text-white w-full max-w-[90vw] mb-[3vw] mt-[5vw] text-start ">Expertise</p>
