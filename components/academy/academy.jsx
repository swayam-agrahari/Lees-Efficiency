export default function Academy() {
  return (
    <div className="bg-white text-black w-full flex flex-col items-center justify-center py-8">
        ...
        <div className="w-full h-full max-w-[95vw] flex flex-wrap justify-center gap-x-[.9vw]">
          <div className="relative [@media(max-width:320px)]:w-[100%] min-h-[30vw] w-[100%]  md:w-[50%] [@media(max-width:320px)]:min-h-[20vh] md:h-0 pb-[28%] bg-gray-100 shadow-lg overflow-hidden">
            <iframe
          ...
          <div className="relative [@media(max-width:320px)]:w-[100%] w-[100%] [@media(max-width:320px)]:min-h-[20vh] min-h-[30vw] md:w-[49%] md:h-0 pb-[28%] bg-gray-100 shadow-lg overflow-hidden">
            <iframe
              className="absolute top-0 left-0 w-full h-full"
