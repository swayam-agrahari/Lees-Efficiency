                    ...
                    <div className="flex flex-[2] flex-col w-full">
                        {data.map((key, index)=>(
                            <Link 
                             ...
                             key={index} 
                             className="group flex relative gap-x-[.5vw] border-b-[1px] border-solid border-black text-[1.4vw] max-md:text-[6vw] text-black hover:text-white bg-transparent z-10 p-[.7vw] max-md:p-[2.1vw] transition-all ease-in-out duration-500">
